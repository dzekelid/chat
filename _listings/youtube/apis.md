...
- name: Youtube Delete Live Chat Messages
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/chat/master/_listings/youtube/livechat-messages-delete.md
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/chat/master/_listings/youtube/livechat-messages-delete-postman.md
x-common:
- type: x-articles
